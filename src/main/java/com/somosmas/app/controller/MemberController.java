...
public class MemberController {
    ...
    public ResponseEntity<?> getMember(@RequestParam("page") int page, UriComponentsBuilder uriBuilder){
        return new ResponseEntity<>(memberService.getMembers(page, uriBuilder), HttpStatus.OK);
    }
